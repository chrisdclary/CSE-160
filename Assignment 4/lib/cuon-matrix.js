...
class Vector3 {
    ...
    static dot(other1, other2) {
        ...
        var f1 = other1.elements;
        var f2 = other2.elements;
    ...
    static cross(other1, other2) {
        ...
        v3.elements[0] = (s[1]*d[2] - s[2]*d[1]);
        v3.elements[1] = (s[2]*d[0] - s[0]*d[2]);
        v3.elements[2] = (s[0]*d[1] - s[1]*d[0]);
    ...
    magnitude() {
        ...
        // Insert your code here.
        d = this.elements;
        let m = Math.sqrt(d[0]*d[0] + d[1]*d[1] + d[2]*d[2]); // Modify this line to calculate this vector's magnitude.
    ...
    normalize() {
        ...
        d = this.elements;
        for (i = 0; i < 3; ++i) {
          this.elements[i] = d[i]/Math.abs(this.magnitude());
        }
        // Don't delete the return statement.
        return this;
    };
